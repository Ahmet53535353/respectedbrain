commit 4df0aee392f834ebfd4783f58b3ed8a32e01f1ce
Author: ahmet <ahmet@example.com>
Date:   Mon Sep 14 00:55:41 2026 +0300

    feat: OpenCode template ve plugin dosyaları eklendi
    
    - template/.opencode/ agents, plugins, skills eklendi
    - template/.beyin/skills/beyin-doktor/SKILL.md'ye OpenCode kontrol eklendi
    - template/.config/ çiftliği kaldırıldı

diff --git a/template/.opencode/agents/beyin.md b/template/.opencode/agents/beyin.md
new file mode 100644
index 0000000..f674a42
--- /dev/null
+++ b/template/.opencode/agents/beyin.md
@@ -0,0 +1,64 @@
+---
